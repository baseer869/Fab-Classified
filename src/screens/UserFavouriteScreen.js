import { SafeAreaView, StatusBar, StyleSheet, Text, View, Image, FlatList, TouchableOpacity } from 'react-native'
...
const UserFavouriteScreen = ({ navigation }) => {
  ...
  React.useEffect(() => {
    ...
    const fetchClassifiedAds = async () => {
      let response = await classifiedAds(`api/adds?uid=${1}`);
